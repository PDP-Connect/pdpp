...
export const POSTGRES_UNNAMED_SKIP_TEST_NAMES = new Set([
  "PostgreSQL device-batch summary-evidence convergence: accepted replay converges the summary primitive without double-counting",
  "PostgreSQL device-batch summary-evidence convergence: manifest registration racing an in-flight device batch converges the summary primitive with no lost update",
  "PostgreSQL device-batch summary-evidence convergence: partial-prefix resume converges the summary primitive on the correct final state",
