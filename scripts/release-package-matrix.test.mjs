...
function row(row) {
  ...
  const commands = [
    ...
    { command: ['npm', 'install', '--ignore-scripts', '--offline', '--force', ...candidates.map(({ tarball }) => `/workspace/.release-matrix/candidates/${tarball.filename}`)], cwd: '/workspace/.release-matrix/consumer' },
