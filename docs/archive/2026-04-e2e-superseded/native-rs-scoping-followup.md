...
The current owner RS contract is connector-scoped at the route layer in [e2e/server/index.js](/e2e/server/index.js:1):
...
These are also connector-scoped in [e2e/server/index.js](/e2e/server/index.js:1), but they should remain out of scope for the first native RS cut:
...
The owner CLI mirrors the same assumption in [e2e/cli/commands/owner.js](/e2e/cli/commands/owner.js:1):
...
The global help text in [e2e/cli/index.js](/e2e/cli/index.js:1) also hardcodes `--connector-id` into every owner command example.
...
- [e2e/server/index.js](/e2e/server/index.js:1)
  - `GET /v1/streams`
  - `GET /v1/streams/:stream`
  - `GET /v1/streams/:stream/records`
  - `GET /v1/streams/:stream/records/:id`

- [e2e/cli/commands/owner.js](/e2e/cli/commands/owner.js:1)
  - remove unconditional `--connector-id` requirement
  - conditionally append `connector_id` only when present

- [e2e/cli/index.js](/e2e/cli/index.js:1)
...
- [e2e/server/records.js](/e2e/server/records.js:1)
- [e2e/server/db.js](/e2e/server/db.js:1)
- [e2e/server/auth.js](/e2e/server/auth.js:1)
- [e2e/server/metadata.js](/e2e/server/metadata.js:1)
