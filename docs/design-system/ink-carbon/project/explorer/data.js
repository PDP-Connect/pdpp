...
// ─── connections ────────────────────────────────────────────────────────
const connections = [
  { id: "c_gmail_p",   connector_id: "gmail",          display_name: "the owner@example.com",      group: "Google",   account_kind: "personal" },
  { id: "c_gmail_w",   connector_id: "gmail",          display_name: "the owner@example.org",         group: "Google",   account_kind: "work" },
  { id: "c_photos",    connector_id: "google_takeout", display_name: "the owner@example.com",      group: "Google",   account_kind: "personal" },
  { id: "c_slack",     connector_id: "slack",          display_name: "acme.slack.com",       group: "Slack",    account_kind: "work" },
  { id: "c_chase",     connector_id: "chase",          display_name: "Chase •6432",          group: "Chase",    account_kind: "personal" },
  { id: "c_amazon",    connector_id: "amazon",         display_name: "the owner@example.com",      group: "Amazon",   account_kind: "personal" },
  { id: "c_github",    connector_id: "github",         display_name: "owner",             group: "GitHub",   account_kind: "personal" },
  { id: "c_strava",    connector_id: "strava",         display_name: "the owner Rivera",        group: "Strava",   account_kind: "personal" },
...
const gmailPersonalRecords = [
  { id: rid("gm"), thread_id: "t01", from: "Maya Chen <maya.chen@figma.com>", to: ["the owner@example.com"], subject: "re: portfolio review thursday", snippet: "Thursday 2pm still works on my end. I'll bring the redlines from the consent flow we talked about — curious what you think of the copper rule on…", date: ago(2 * HOUR), labels: ["Inbox", "Starred"], has_attachment: false, body: "Thursday 2pm still works on my end. I'll bring the redlines from the consent flow we talked about — curious what you think of the copper rule on the grant inspector. Also: I think I figured out the weird thing with the right-pane scrim, I'll show you in person.\n\nMaya" },
  { id: rid("gm"), thread_id: "t02", from: "Southwest Airlines <noreply@iluv.southwest.com>", to: ["the owner@example.com"], subject: "Your trip to Austin is confirmed — May 31", snippet: "Confirmation L4M2QP · the owner Rivera · SFO → AUS · Sat May 31 · 6:35a · Wanna Get Away+", date: ago(8 * HOUR), labels: ["Inbox", "Travel"], has_attachment: true },
  { id: rid("gm"), thread_id: "t03", from: "Anthropic <noreply@account.anthropic.com>", to: ["the owner@example.com"], subject: "Your monthly receipt", snippet: "Receipt for May 2026 — Claude Pro $20.00 charged to Visa ending in 6432. Thanks for being a subscriber.", date: ago(1 * DAY + 4 * HOUR), labels: ["Inbox", "Receipts"], has_attachment: true },
  { id: rid("gm"), thread_id: "t04", from: "mom <ellen.rivera@example.com>", to: ["the owner@example.com"], subject: "the chickens", snippet: "Hattie laid a green egg today!! It's the size of a quarter. Sending pics. Dad says hi and is mad about the gutters again.", date: ago(2 * DAY), labels: ["Inbox"], has_attachment: true },
  { id: rid("gm"), thread_id: "t05", from: "Tara Patel <tara@longview.app>", to: ["the owner@example.com"], subject: "Longview client integration — grant ready?", snippet: "Hi the owner — we got our scoped grant approved this morning. Wanted to flag: we're noticing some streams come back with `connection_id` populated and some without…", date: ago(3 * DAY + 6 * HOUR), labels: ["Inbox"], has_attachment: false },
  { id: rid("gm"), thread_id: "t06", from: "Strava <no-reply@strava.com>", to: ["the owner@example.com"], subject: "Your weekly summary: 31.4 mi", snippet: "Nice work this week. 3 runs · 31.4 mi · 4h 48m · 1,247 ft elevation. New all-time best for May.", date: ago(4 * DAY), labels: ["Inbox", "Updates"], has_attachment: false },
  { id: rid("gm"), thread_id: "t07", from: "Chase Online <no-reply@chase.com>", to: ["the owner@example.com"], subject: "Alert: large purchase on •6432", snippet: "A $487.14 purchase at Apple Store was made on May 19. If this was you, no action needed. Otherwise reply STOP or call us.", date: ago(5 * DAY), labels: ["Inbox", "Banking"], has_attachment: false },
  { id: rid("gm"), thread_id: "t08", from: "GitHub <noreply@github.com>", to: ["the owner@example.com"], subject: "[vana-com/pdpp] PR #847 was merged: capability dispatch in explorer", snippet: "Merged by @maya-chen · 12 files changed · +482 −137", date: ago(6 * DAY), labels: ["Inbox", "Code"], has_attachment: false },
  { id: rid("gm"), thread_id: "t09", from: "Spotify <no-reply@spotify.com>", to: ["the owner@example.com"], subject: "Your minutes this month: 1,847", snippet: "You listened more than 87% of users in San Francisco this month. Top artist: Caroline Polachek. Top genre: art pop.", date: ago(8 * DAY), labels: ["Inbox"], has_attachment: false },
  { id: rid("gm"), thread_id: "t10", from: "Maya Chen <maya.chen@figma.com>", to: ["the owner@example.com"], subject: "stair brewery sat?", snippet: "they have the saison on tap again. 4ish? bring the dog", date: ago(12 * DAY), labels: ["Inbox", "Starred"], has_attachment: false },
  { id: rid("gm"), thread_id: "t11", from: "Costco Wholesale <orders@costco.com>", to: ["the owner@example.com"], subject: "Your Costco order is ready for pickup", snippet: "Order #C-58291 · Pickup window: May 14, 4–6pm · 8 items · Total: $213.47", date: ago(14 * DAY), labels: ["Inbox", "Receipts"], has_attachment: false },
  { id: rid("gm"), thread_id: "t12", from: "ACLU <action@aclu.org>", to: ["the owner@example.com"], subject: "the owner — your May donation receipt", snippet: "Thank you for your monthly $25 contribution. Tax receipt attached. Every dollar funds the fight.", date: ago(18 * DAY), labels: ["Inbox", "Receipts"], has_attachment: true },
];

const gmailWorkRecords = [
  { id: rid("gm"), thread_id: "t20", from: "Jordan Vasquez <jordan@example.org>", to: ["the owner@example.org"], subject: "[PDPP] design review — explorer prototype", snippet: "Sending notes from yesterday. tldr: the field-projection toggle is the killer feature, lean into it. also: command-K should default to lexical not semantic.", date: ago(4 * HOUR), labels: ["Inbox", "Important"], has_attachment: false },
  { id: rid("gm"), thread_id: "t21", from: "Jordan Vasquez <jordan@example.org>", to: ["the owner@example.org", "maya@example.org"], subject: "Re: launch readiness sync", snippet: "Pushing tomorrow's standup to 10:30 — Maya has the IETF call at 9. Agenda is in the doc, anyone can add.", date: ago(1 * DAY), labels: ["Inbox"], has_attachment: false },
  { id: rid("gm"), thread_id: "t22", from: "Calendar <calendar-notification@google.com>", to: ["the owner@example.org"], subject: "Invitation: PDPP biweekly (May 27)", snippet: "Wed May 27 · 11:00–11:30 · Jordan, Maya, the owner, Drew · Zoom · recurring biweekly", date: ago(2 * DAY), labels: ["Inbox", "Calendar"], has_attachment: false },
  { id: rid("gm"), thread_id: "t23", from: "Drew Park <drew@example.org>", to: ["the owner@example.org"], subject: "fwd: from the IETF list", snippet: "Worth a read — the working group is converging on something close to PDPP's grant model. They're calling it scoped-read profiles.", date: ago(5 * DAY), labels: ["Inbox"], has_attachment: false },
  { id: rid("gm"), thread_id: "t24", from: "1Password <noreply@1password.com>", to: ["the owner@example.org"], subject: "New device signed in", snippet: "A new device (MacBook Pro · Safari 18) signed into your work vault from San Francisco, CA. If this was you, no action needed.", date: ago(8 * DAY), labels: ["Inbox", "Security"], has_attachment: false },
  { id: rid("gm"), thread_id: "t25", from: "Notion <team@mail.notion.so>", to: ["the owner@example.org"], subject: "Jordan shared a page with you: \"explorer copy passes\"", snippet: "Jordan Vasquez shared the page \"explorer copy passes\" in the Acme workspace. 14 comments waiting.", date: ago(10 * DAY), labels: ["Inbox"], has_attachment: false },
];
...
const slackRecords = [
  { id: rid("sl"), channel: "#eng-platform", channel_id: "C01", thread_ts: null, author: "Jordan Vasquez", text: "ok the dispatch is in. capability detection working for gmail/slack/chase. amazon/strava next.", ts: ago(45 * MIN), reactions: [{emoji: "🚀", count: 3}, {emoji: "👀", count: 1}], is_dm: false },
  { id: rid("sl"), channel: "#eng-platform", channel_id: "C01", thread_ts: null, author: "the owner Rivera", text: "nice. how is it handling streams with mixed signals (e.g. photos has timestamp + geo + blob)?", ts: ago(40 * MIN), reactions: [], is_dm: false },
  { id: rid("sl"), channel: "#eng-platform", channel_id: "C01", thread_ts: null, author: "Jordan Vasquez", text: "lights up all three views. table is always there as floor. honestly feels right", ts: ago(38 * MIN), reactions: [{emoji: "💯", count: 2}], is_dm: false },
  ...
  { id: rid("sl"), channel: "#general", channel_id: "C00", thread_ts: null, author: "Jordan Vasquez", text: "reminder: launch readiness sync tomorrow 10:30, not 9. agenda doc is open for additions", ts: ago(5 * HOUR), reactions: [{emoji: "🗓️", count: 7}], is_dm: false },
  ...
  { id: rid("sl"), channel: "DM with Maya Chen", channel_id: "D01", thread_ts: null, author: "the owner Rivera", text: "screen is fine. coffee plan stands?", ts: ago(1 * DAY + 1 * HOUR + 50 * MIN), reactions: [{emoji: "☕", count: 1}], is_dm: true },
  ...
  { id: rid("sl"), channel: "#eng-platform", channel_id: "C01", thread_ts: null, author: "the owner Rivera", text: "the explorer is going to expose that as a pill in command-K. \"lex / sem / hybrid\". feels right", ts: ago(1 * DAY + 5 * HOUR + 30 * MIN), reactions: [{emoji: "💡", count: 1}], is_dm: false },
  ...
  { id: rid("sl"), channel: "#design", channel_id: "C02", thread_ts: null, author: "the owner Rivera", text: "memories. heatmap is dense — better as a second-fold module. memories is what you want to *open* the app for", ts: ago(2 * DAY + 3 * HOUR + 55 * MIN), reactions: [{emoji: "✨", count: 3}], is_dm: false },
  ...
  { id: rid("sl"), channel: "DM with Jordan Vasquez", channel_id: "D02", thread_ts: null, author: "Jordan Vasquez", text: "are you good to demo the explorer at the IETF thing wed? 15 min slot, second half can be Q&A", ts: ago(3 * DAY), reactions: [], is_dm: true },
  { id: rid("sl"), channel: "DM with Jordan Vasquez", channel_id: "D02", thread_ts: null, author: "the owner Rivera", text: "yes. i'll lead with the field-projection toggle. that's the moment.", ts: ago(3 * DAY - 10 * MIN), reactions: [{emoji: "💪", count: 1}], is_dm: true },
  { id: rid("sl"), channel: "#general", channel_id: "C00", thread_ts: null, author: "Jordan Vasquez", text: "spec working group put out 0.9-rc1. our reference impl validates clean against it. one minor breaking change in /v1/search results shape — drew's PR covers it", ts: ago(5 * DAY), reactions: [{emoji: "📦", count: 5}], is_dm: false },
...
const githubRecords = [
  { id: rid("gh"), type: "PullRequest",   repo: "vana-com/pdpp",   title: "explorer: capability dispatch + tier-1 table view", body: "Implements the schema-signal dispatch we discussed. Streams now declare typed fields and the explorer infers timeline/map/gallery/ledger/conversation/calendar/reader/chart eligibility from the fields, not the connector id.", actor: "owner", created_at: ago(3 * HOUR), url: "https://github.com/PDP-Connect/pdpp/pull/851", additions: 712, deletions: 184 },
  { id: rid("gh"), type: "Push",          repo: "vana-com/pdpp",   title: "fix: peek panel respects field projection toggle", body: "Was showing all fields regardless of grant.", actor: "owner", created_at: ago(8 * HOUR), url: "https://github.com/PDP-Connect/pdpp/commit/a47c2d1", additions: 28, deletions: 12 },
  { id: rid("gh"), type: "PullRequest",   repo: "vana-com/pdpp",   title: "search: expose mode (lexical/semantic/hybrid)", body: "Propagates the new search mode enum through MCP and the dashboard search view.", actor: "drewpark", created_at: ago(1 * DAY + 2 * HOUR), url: "https://github.com/PDP-Connect/pdpp/pull/848", additions: 412, deletions: 89 },
  { id: rid("gh"), type: "PullRequest",   repo: "vana-com/pdpp",   title: "[merged] capability dispatch in explorer", body: "First version of the dispatch + table fallback. Connector-specific layouts will land in follow-up PRs.", actor: "mayachen", created_at: ago(6 * DAY), url: "https://github.com/PDP-Connect/pdpp/pull/847", additions: 482, deletions: 137 },
  { id: rid("gh"), type: "Issue",         repo: "vana-com/pdpp",   title: "chase connector loses trusted-device cookie between runs", body: "Every run requires fresh SMS OTP. Suspect _tmprememberme is session-only.", actor: "owner", created_at: ago(6 * DAY + 4 * HOUR), url: "https://github.com/PDP-Connect/pdpp/issues/843", additions: 0, deletions: 0 },
  { id: rid("gh"), type: "Push",          repo: "owner/resource-budget", title: "0.4.2: nicer histogram colors", body: "Use copper for the bars and grey for the baseline.", actor: "owner", created_at: ago(9 * DAY), url: "https://github.com/owner/resource-budget/commit/9d7e3a2", additions: 14, deletions: 8 },
  { id: rid("gh"), type: "PullRequest",   repo: "vana-com/pdpp",   title: "polyfill-connectors: scaffold loom + linkedin", body: "Manifest + connector shell only; selectors TBD with live co-pilot session.", actor: "owner", created_at: ago(12 * DAY), url: "https://github.com/PDP-Connect/pdpp/pull/831", additions: 348, deletions: 0 },
  { id: rid("gh"), type: "Issue",         repo: "vana-com/pdpp",   title: "MCP `search` mode pill not surfaced in agent skill", body: "We added the enum but the agent skill instructions still pin mode=lexical.", actor: "annavasquez", created_at: ago(15 * DAY), url: "https://github.com/PDP-Connect/pdpp/issues/827", additions: 0, deletions: 0 },
  ...
  { id: rid("gh"), type: "PullRequest",   repo: "vana-com/pdpp",   title: "docs: human/protocol duality writeup", body: "Adds README section on the 2px copper-vs-blue temperature system.", actor: "mayachen", created_at: ago(23 * DAY), url: "https://github.com/PDP-Connect/pdpp/pull/814", additions: 187, deletions: 14 },
];
...
const photosRecords = [
  ...
  { id: rid("ph"), taken_at: ago(3 * DAY),         caption: "Jordan's whiteboard sketch", thumbnail: "https://picsum.photos/seed/whiteboard/600", lat: 37.7794, lng: -122.4078 },
...
const calendarRecords = [
  { id: rid("cal"), title: "Standup",                            start: at(NOW + 14 * HOUR),     end: at(NOW + 14.5 * HOUR), location: "Zoom",            attendees: ["Jordan Vasquez","Maya Chen","Drew Park","the owner Rivera"] },
  { id: rid("cal"), title: "Coffee w/ Maya",                     start: at(NOW + 1 * DAY + 6 * HOUR),  end: at(NOW + 1 * DAY + 7 * HOUR), location: "Ritual Coffee Mission", attendees: ["Maya Chen","the owner Rivera"] },
  { id: rid("cal"), title: "Portfolio review w/ Maya",           start: at(NOW + 3 * DAY + 5 * HOUR),  end: at(NOW + 3 * DAY + 6 * HOUR), location: "Figma SF",              attendees: ["Maya Chen","the owner Rivera"] },
  { id: rid("cal"), title: "PDPP biweekly",                      start: at(NOW + 3 * DAY + 11 * HOUR), end: at(NOW + 3 * DAY + 11.5 * HOUR), location: "Zoom",          attendees: ["Jordan Vasquez","Maya Chen","Drew Park","the owner Rivera"] },
...
const deepGmail = [
  { id: rid("gm"), thread_id: "th1", from: "Maya Chen <maya.chen@figma.com>", to: ["the owner@example.com"], subject: "happy birthday old man", snippet: "hope it's a good one. drinks tomorrow at zeitgeist?", date: Y(2025, 5, 24, 9), labels: ["Inbox", "Starred"], has_attachment: false },
  { id: rid("gm"), thread_id: "th2", from: "United Airlines <flights@united.com>", to: ["the owner@example.com"], subject: "Your flight to Tokyo on May 24 is confirmed", snippet: "SFO → NRT · UA837 · 11:40am · seat 14A", date: Y(2024, 5, 24, 7), labels: ["Inbox", "Travel"], has_attachment: true },
  { id: rid("gm"), thread_id: "th3", from: "Jordan Vasquez <jordan@example.org>", to: ["the owner@example.com"], subject: "welcome to vana", snippet: "the owner — so glad to have you on board. Here's everything you need for your first week.", date: Y(2023, 8, 14, 10), labels: ["Inbox", "Important"], has_attachment: true },
  { id: rid("gm"), thread_id: "th4", from: "Apple <noreply@apple.com>", to: ["the owner@example.com"], subject: "Your iPhone 13 is ready for pickup", snippet: "Order #W4729103 · Apple Store Stockton St", date: Y(2022, 9, 24, 14), labels: ["Inbox", "Receipts"], has_attachment: false },
  { id: rid("gm"), thread_id: "th5", from: "mom <ellen.rivera@example.com>", to: ["the owner@example.com"], subject: "the new puppy!!", snippet: "we named her hattie. sending all the photos.", date: Y(2021, 4, 11, 17), labels: ["Inbox"], has_attachment: true },
  { id: rid("gm"), thread_id: "th6", from: "Square <receipts@squareup.com>", to: ["the owner@example.com"], subject: "Receipt from Ritual Coffee", snippet: "$4.50 · cortado · Tip $1.00", date: Y(2020, 3, 7, 9), labels: ["Inbox", "Receipts"], has_attachment: false },
  { id: rid("gm"), thread_id: "th7", from: "OkCupid <noreply@okcupid.com>", to: ["the owner@example.com"], subject: "You have a new match", snippet: "Someone liked you back. Open the app to chat.", date: Y(2019, 7, 22, 20), labels: ["Inbox"], has_attachment: false },
  { id: rid("gm"), thread_id: "th8", from: "Stanford Alumni <alumni@stanford.edu>", to: ["the owner@example.com"], subject: "Class of 2014 — 5-year reunion", snippet: "Save the date: October 19, 2019. Memorial Auditorium.", date: Y(2018, 11, 2, 11), labels: ["Inbox"], has_attachment: false },
];
...
const deepGithub = [
  { id: rid("gh"), type: "PullRequest", repo: "vana-com/pdpp", title: "init repo, README", body: "Hello world.", actor: "owner", created_at: Y(2023, 9, 1, 14), url: "https://github.com/PDP-Connect/pdpp/pull/1", additions: 412, deletions: 0 },
  ...
  { id: rid("gh"), type: "PullRequest", repo: "owner/resource-budget", title: "0.1.0 — initial release", body: "", actor: "owner", created_at: Y(2020, 11, 19, 16), url: "", additions: 1_482, deletions: 0 },
];
...
const streams = [
  {
    ...
    title: "Gmail · personal", icon: "✉", connection_display: "the owner@example.com",
  ...
  },
  {
    ...
    title: "Gmail · work", icon: "✉", connection_display: "the owner@example.org",
  ...
  },
  {
    ...
    title: "Slack · vana", icon: "▤", connection_display: "acme.slack.com",
  ...
  },
  {
    ...
    title: "Amazon · orders", icon: "▪", connection_display: "the owner@example.com",
  ...
  },
  {
    ...
    title: "Strava · activities", icon: "↗", connection_display: "the owner Rivera",
  ...
  },
  {
    ...
    title: "Photos · Takeout", icon: "□", connection_display: "the owner@example.com",
