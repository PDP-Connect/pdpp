...
const githubRecords = [
  ...
  { id: rid("gh"), type: "Issue",         repo: "vana-com/pdpp",   title: "MCP `search` mode pill not surfaced in agent skill", body: "We added the enum but the agent skill instructions still pin mode=lexical.", actor: "annavasquez", created_at: ago(15 * DAY), url: "https://github.com/vana-com/pdpp/issues/827", additions: 0, deletions: 0 },
