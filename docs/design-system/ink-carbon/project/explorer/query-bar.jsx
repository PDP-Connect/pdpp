  ...
  function QueryBar({ query, onChange, streams, mode, onModeChange, focused, onFocusedChange }) {
    ...
    return (
      <div style={{ position: "relative" }}>
        {/* biome-ignore lint/a11y/noStaticElementInteractions lint/a11y/noNoninteractiveElementInteractions lint/a11y/useKeyWithClickEvents: the wrapper only expands the pointer target of its contained keyboard-accessible input. */}
        <div
          className="exp-query"
