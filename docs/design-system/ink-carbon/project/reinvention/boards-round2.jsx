  ...
  function VCarbon() {
    return (
      <div className="vs cc">
        ...
        <h2 className="cc-statement">
          Every grant writes <em>two copies</em>. Yours is the original.
        </h2>
          ...
          <div className="cc-card">
            ...
            <div className="cc-card__foot">
              ...
              <div className="vs-actions">
                ...
                <button className="cc-btn cc-btn--ghost" type="button">
                  Refuse
                </button>
              </div>
            </div>
        ...
        <div className="vs-tags">
          ...
          <span className="cc-tag" style={{ textDecoration: "line-through" }}>
            Revoked
          </span>
        </div>
        <Chips
          items={[
            ["oklch(0.99 0.003 250)", "paper"],
            ["oklch(0.21 0.012 270)", "ink"],
  ...
  function VRibbon() {
    return (
      <div className="vs rb">
        ...
        <h2 className="rb-statement">
          The record is typed in black. <b>No is typed in red.</b>
        </h2>
        <div className="rb-h">Consent</div>
        <div className="rb-card">
          <div className="rb-line">
            <span className="rb-line__k">grantee</span>
            <span>Longview Planning</span>
          </div>
          <div className="rb-line">
            <span className="rb-line__k">purpose</span>
            <span>long_term_financial_planning</span>
          </div>
          {SCOPES.map((s) => (
            <div className="rb-line rb-line--scope" key={s.name}>
              <span>{s.name}</span>
              <span className="rb-line__k">{s.terms}</span>
            </div>
          ))}
          <div className="rb-line rb-line--scope">
            <span className="rb-revoked">browsing.read</span>
            <span className="rb-tag--red rb-tag">refused</span>
          </div>
        </div>
        <div className="vs-tags">
        ...
        <div className="vs-actions">
          ...
          <button className="rb-btn rb-btn--red" type="button">
            Refuse
          </button>
        </div>
        <Chips
          items={[
            ["oklch(0.962 0.01 92)", "paper"],
            ["oklch(0.25 0.015 75)", "ink"],
            ["oklch(0.54 0.19 27)", "ribbon red"],
          ]}
  ...
  function VClarendon() {
    return (
      <div className="vs cl">
        ...
        <h2 className="cl-statement">
          Consent, <b>recorded</b> — with the gravity of a ledger and none of the dust.
        </h2>
        <div className="cl-card">
          ...
          <div className="vs-actions" style={{ marginTop: 4 }}>
            ...
            <button className="cl-btn cl-btn--ghost" type="button">
              Decline
            </button>
          </div>
        </div>
    ...
    return (
      <div className="vs pc">
        ...
        <div className="vs-actions">
          ...
          <button className="pc-btn pc-btn--ghost" type="button">
            Leave blank
          </button>
        </div>
        <Chips
          items={[
            ["oklch(0.93 0.028 92)", "card buff"],
  ...
  function VCivic() {
    return (
      <div className="vs cb">
        ...
        <h2 className="cb-statement">
          Your data. <b>Your terms.</b> In writing.
        </h2>
        <div className="cb-card">
          ...
          <div className="vs-actions" style={{ marginTop: 4 }}>
            ...
            <button className="cb-btn cb-btn--ghost" type="button">
              Refuse
            </button>
          </div>
        </div>
  ...
  function VGreenbar() {
    return (
      <div className="vs gb" style={{ paddingLeft: 30, paddingRight: 30, position: "relative" }}>
        ...
        <h2 className="gb-statement">
          The server prints what crossed. <b>Every band, accounted for.</b>
        </h2>
        <div className="gb-card">
          ...
          <div className="gb-row">
            <span>queries this cycle</span>
            <span className="gb-row__terms">14 · all inside grant</span>
          </div>
          <div className="gb-row">
            <span>last sync</span>
            <span className="gb-row__terms">2025-11-04 11:05Z</span>
          </div>
        </div>
        <div className="vs-tags">
        ...
        <div className="vs-actions">
          <button className="gb-btn" type="button">
            Approve
          </button>
          <button className="gb-btn gb-btn--ghost" type="button">
            Refuse
          </button>
        </div>
        <Chips
          items={[
            ["oklch(0.99 0.004 140)", "paper"],
            ["oklch(0.945 0.028 162)", "band"],
            ["oklch(0.24 0.012 250)", "ink"],
            ["oklch(0.42 0.06 165)", "print green"],
          ]}
