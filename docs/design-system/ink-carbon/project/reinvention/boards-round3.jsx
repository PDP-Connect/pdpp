...
function Consent({ t }) {
  const isT1 = t === "t1", isT2 = t === "t2", isT3 = t === "t3";
  const endorse = isT2
    ? (s) => `[${s.toUpperCase()}]`
    : isT3
      ? (s) => (s === "active" ? "● " + s : s)
    ...
    <div className={`s3 lite ${t} hc`}>
      ...
      <div className="hc-main">
        <div>
          ...
          <p className="hc-lede">
            Purpose: <b>long-term financial planning</b>. Only the fields below cross.
            Every response is projected to this grant — nothing else leaves Northstar HR.
          </p>
        </div>
        <div className="hc-sheetwrap">
          ...
          <div className="hc-sheet">
            ...
            <div className="hc-sheet__foot">
              ...
              <span className="hc-meta"><span>expires 2026-12-14</span></span>
            </div>
          </div>
        </div>
      ...
      <div className="hc-foot">
        <button className="hc-btn hc-btn--go" type="button">Approve 2 streams</button>
        <button className="hc-btn hc-btn--ghost" type="button">Deny</button>
...
const NAV = [
  ["Overview", "", true], ["Explore", ""], ["Sources", "7"], ["Traces", ""],
  ["Grants", "4"], ["Runs", "12"], ["Schedules", "2"], ["Connect AI apps", ""], ["Deployment", ""],
];
const GRANTS = [
  { client: "Longview Planning", id: "grt_lngvw_01", scopes: "pay_statements.read · employment.read", exp: "exp 2026-12-14", st: ["st-ok", "active"], dupe: true },
  { client: "Concert Recommendations", id: "grt_cncrt_02", scopes: "listening_history.read", exp: "continuous", st: ["st-pro", "continuous"] },
  { client: "pdpp CLI — owner export", id: "dev_cli_07", scopes: "* (owner device flow)", exp: "exp 2026-06-11", st: ["st-warn", "expiring 26h"] },
  { client: "Crosswise Ads", id: "grt_xwise_09", scopes: "browsing.read", exp: "2026-05-02", st: ["st-off", "revoked"], revoked: true },
];

function Console({ t }) {
  const isT2 = t === "t2", isT3 = t === "t3";
    ...
    <div className={`s3 dark ${t} oc`}>
      <div className="oc-side">
        ...
        <div className="oc-side__foot">
          AS :7662 · RS :7663<br />composed @ localhost:3002<br />rev 668ecf811d47
        </div>
      </div>
      <div className="oc-main">
        ...
        <div className="oc-band">
          <div className="oc-cell"><span className="oc-cell__v">2</span><span className="oc-cell__k">connectors</span></div>
          <div className="oc-cell"><span className="oc-cell__v">7</span><span className="oc-cell__k">streams</span></div>
          <div className="oc-cell"><span className="oc-cell__v">48,112</span><span className="oc-cell__k">records</span></div>
          <div className="oc-cell"><span className="oc-cell__v">1.21 GB</span><span className="oc-cell__k">retained</span></div>
        </div>
        <div>
          ...
          <div className="oc-list">
            {GRANTS.map((g) => (
              <div className={"oc-row" + (g.dupe && t === "t1" ? " oc-row--dupe" : "") + (g.revoked ? " oc-row--revoked" : "")} key={g.id}>
