      ...
      <div className="env">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 24 }}>
          ...
          <p className="env-note" style={{ textAlign: "right" }}>
            ref — security-tint envelopes,
            <br />
            die-cut windows, permit indicia,
            <br />
            certified-mail green cards
          </p>
        </div>
        ...
        <p className="env-body">
          A security tint has exactly one job: keeping personal data unreadable in transit. A window envelope reveals
          exactly the named fields and nothing else. PDPP already works this way — the brand just admits it.{" "}
          <b>Granted is typed. Withheld is tinted.</b>
        </p>
        ...
        <div>
          ...
          <div className="env-ramp" style={{ marginTop: 6 }}>
            ...
            <div className="env-ramp__row">
              ...
              <span style={{ fontFamily: "var(--env-type)", fontSize: 15 }}>
      ...
      <div className="env" style={{ gap: 24 }}>
        ...
        <div className="env-receipt">
          ...
          <div className="env-receipt__grid">
            <div className="env-receipt__cell">
              <span className="env-receipt__k">Grantee</span>
              <span className="env-receipt__v">Longview Planning</span>
            </div>
            <div className="env-receipt__cell">
              <span className="env-receipt__k">Mode</span>
              <span className="env-receipt__v">continuous</span>
            </div>
            <div className="env-receipt__cell">
              <span className="env-receipt__k">Issued</span>
              <span className="env-receipt__v">2025-10-14 09:22Z</span>
            </div>
            <div className="env-receipt__cell">
              <span className="env-receipt__k">Expires</span>
              <span className="env-receipt__v">2025-12-14 09:22Z</span>
            </div>
            <div className="env-receipt__cell">
              <span className="env-receipt__k">Scopes</span>
              <span className="env-receipt__v">2 granted · 2 sealed</span>
            </div>
            <div className="env-receipt__cell">
              <span className="env-receipt__k">Purpose</span>
              <span className="env-receipt__v">long_term_financial_planning</span>
            </div>
          </div>
        </div>
        ...
        <div className="env-actions">
          <button className="env-btn" type="button">
            Approve &amp; seal
          </button>
          <button className="env-btn env-btn--ghost" type="button">
            Adjust windows
          </button>
          <button className="env-btn env-btn--return" type="button">
            Return to sender
          </button>
        </div>
      </div>
