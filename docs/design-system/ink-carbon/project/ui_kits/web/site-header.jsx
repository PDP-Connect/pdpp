...
const SiteHeader = ({ active = "home", onNav }) => {
  const navigate = (event) => onNav?.(event.currentTarget.dataset.page);
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span className="pdpp-chip" style={{ marginLeft: 4, fontSize: 11, padding: "0 6px" }}>
            v0.1.0
          </span>
        </div>
        <nav style={{ display: "flex", alignItems: "center", gap: 4 }}>
          ...
          <button className="pdpp-btn pdpp-btn-outline" style={{ height: 30, fontSize: 12.5 }} type="button">
