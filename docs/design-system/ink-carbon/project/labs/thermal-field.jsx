...
const { MarkP, NightToggle } = window;
const ThermalField = () => (
  <section
    style={{
      position: "relative",
  ...
  >
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        {/* biome-ignore lint/a11y/useValidAnchor: this standalone visual study intentionally uses an inert placeholder link. */}
    ...
    >
      <div style={{ borderLeft: "2px solid var(--human)", paddingLeft: 16 }}>
        ...
        <div className="t-mono" style={{ marginTop: 6, color: "var(--ink)" }}>
          you
        </div>
        <div className="t-small" style={{ marginTop: 2, fontStyle: "italic", fontFamily: "var(--font-serif)" }}>
    ...
    <div
      style={{ marginTop: 56, height: 1, background: "var(--thermal)", opacity: 0.5, position: "relative", zIndex: 1 }}
    />
    ...
    >
      ...
      <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
        ...
        <button className="btn btn-paper" type="button">
