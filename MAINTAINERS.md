...
PDPP uses public pull requests for changes to the protocol text, reference implementation, and site. Non-trivial protocol, reference contract, or architecture changes are tracked with OpenSpec before implementation.
