    ...
    <PdppConceptShell>
      <PdppConceptFrontPage>
        <PdppConceptDoc>
          ...
          <div className="mt-7 flex flex-wrap items-center gap-x-4 gap-y-3 max-[460px]:flex-col max-[460px]:items-stretch max-[460px]:**:data-[slot=pdpp-editorial-button]:justify-center">
