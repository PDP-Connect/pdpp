...
const GITHUB_REPO = "https://github.com/PDP-Connect/pdpp";
...
docker compose up -d`}
        ...
        <section className="mt-14" data-testid="blessed-self-service-journey">
          ...
          <p className="pdpp-caption mt-3 text-muted-foreground">
            ...
            for an ephemeral no-account trial, a stable option with no owned domain (ngrok's assigned Dev Domain), and
            a stable option if you already own a domain (Cloudflare named tunnel), then{" "}
