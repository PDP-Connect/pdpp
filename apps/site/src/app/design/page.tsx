...
import type { SpecCitationProps } from "@/components/sections/spec-citation.tsx";
import { SpecCitationGroup } from "@/components/sections/spec-citation.tsx";
  ...
  return (
    <SectionWrap id="brand">
      ...
      <div className="mb-3 grid grid-cols-1 gap-3 md:grid-cols-2">
        <MarkPlate caption="I.1 — the seam, positive" meta="primary · light surface" surface="light" />
        <MarkPlate caption="I.2 — the seam, night" meta="primary · dark surface" surface="dark" />
      </div>
      ...
      <BrandPlate caption="IV — the full ramp" meta="140 · 96 · 64 · 44 · 28 · 20 · 16 px">
        <div className="flex flex-wrap items-end gap-8 py-2">
          {[140, 96, 64, 44, 28, 22, 20, 16].map((s) => (
            <PdppLogo key={s} size={s} title="" variant="mark" />
          ))}
        </div>
      </BrandPlate>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        ...
        <BrandPlate caption="V.2 — card, night" darkStage meta="ink substrate · 32px mark">
          <div
          ...
          >
            <PdppLogo size={32} surface="dark" title="" variant="mark" />
            <div>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center p-12">
        <PdppLogo size={180} surface={surface} variant="mark" />
      </div>
      <div
...
function ConstructionDiagram() {
  return (
    <svg
      ...
      width="200"
    >
      <title>PDPP logo construction diagram</title>
      {/* 5-unit grid */}
      <g stroke="oklch(0.92 0.01 60)" strokeWidth="0.5">
        <line x1="0" x2="200" y1="30" y2="30" />
        <line x1="0" x2="200" y1="73" y2="73" />
        <line x1="0" x2="200" y1="116" y2="116" />
        <line x1="0" x2="200" y1="170" y2="170" />
        <line x1="40" x2="40" y1="0" y2="200" />
        <line x1="105" x2="105" y1="0" y2="200" />
        <line x1="155" x2="155" y1="0" y2="200" />
      </g>
      {/* Faint mark outline */}
      <g fill="none" opacity="0.3" stroke="var(--foreground)" strokeWidth="0.6">
      ...
      {/* Thermal seam */}
      <defs>
        <linearGradient id="pdpp-construction-thermal" x1="0" x2="1" y1="0" y2="0">
          <stop offset="0" stopColor="oklch(0.52 0.11 45)" />
          <stop offset="1" stopColor="oklch(0.58 0.18 253)" />
        </linearGradient>
      </defs>
      <line stroke="url(#pdpp-construction-thermal)" strokeWidth="1.5" x1="105" x2="105" y1="30" y2="116" />
      {/* Construction points */}
      ...
      <text fill="var(--muted-foreground)" fontFamily="var(--font-mono)" fontSize="7" x="4" y="196">
            ...
            {COLOR_GROUPS.map(({ label, tokens }, gi) => (
              <React.Fragment key={label}>
                <tr style={{ borderTop: gi > 0 ? "1px solid var(--border)" : undefined }}>
                  <td className="pt-6 pb-1.5" colSpan={5}>
                    <span
    ...
    <SectionWrap id="typography">
      ...
      <div className="flex flex-col gap-14">
        ...
        <div>
          ...
          >
            {["Role", "Specimen"].map((h) => (
              <span className="font-medium text-xs" key={h} style={{ color: "var(--muted-foreground)" }}>
                {h}
              </span>
            ))}
          </div>
...
function SpacingSection() {
  ...
  return (
    <SectionWrap id="spacing">
      <SectionHeader description="Standard Tailwind 4px base grid throughout. No arbitrary values." title="Spacing" />

      <div className="mb-10 flex flex-wrap items-end gap-4 py-6">
        {steps.map((n) => (
          <div className="flex flex-col items-center gap-2" key={n}>
            <div
  ...
  return (
    <div style={{ borderTop: "1px solid var(--border)" }}>
      {tiers.map(({ name, ms, cssVar }) => (
        <div className="flex items-center gap-4 py-3 md:gap-6" key={name}>
      ...
      <div className="flex flex-col gap-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              <Card className="border-primary/25" size="sm">
                <CardContent className="p-3">
    ...
    <SectionWrap id="dashboard">
      ...
      <div className="flex flex-col gap-12">
        ...
        <div>
          ...
          <div className="rounded-lg border border-border/80 bg-background p-6">
            <PageHeader
              ...
              meta={
                <>
                  <MetaPill label="status" tone="success" value="succeeded" />
                  <MetaPill label="connector" tone="protocol" value="github" />
        ...
        <div>
          ...
          <div className="rounded-lg border border-border/80 bg-background p-6">
            <Toolbar>
              <label className="flex min-w-0 flex-col gap-1" htmlFor="design-toolbar-query">
                <span className="pdpp-eyebrow">Query</span>
                <Input
                  className="w-56 font-mono"
                  defaultValue=""
                  id="design-toolbar-query"
                  placeholder="id contains…"
                  type="search"
                />
              </label>
              <label className="flex min-w-0 flex-col gap-1" htmlFor="design-toolbar-status">
                <span className="pdpp-eyebrow">Status</span>
                <Select defaultValue="" id="design-toolbar-status">
        ...
        <div>
          ...
          <div className="rounded-lg border border-border/80 bg-background p-6">
            <div className="grid gap-4 md:grid-cols-3">
              <label className="flex min-w-0 flex-col gap-1" htmlFor="design-form-text-input">
                <span className="pdpp-eyebrow">Text input</span>
                <Input defaultValue="" id="design-form-text-input" placeholder="client_id" type="text" />
              </label>
              <label className="flex min-w-0 flex-col gap-1" htmlFor="design-form-select">
                <span className="pdpp-eyebrow">Select</span>
                <Select defaultValue="" id="design-form-select">
              ...
              <label className="flex min-w-0 flex-col gap-1 md:col-span-3" htmlFor="design-form-textarea">
                <span className="pdpp-eyebrow">Textarea</span>
                <Textarea
                  defaultValue=""
                  id="design-form-textarea"
          ...
          <div className="rounded-lg border border-border/80 bg-background p-6">
            <DataList>
              {["run_1776830422766", "run_1776753603111", "run_1776755678518"].map((id, i) => {
                ...
                return (
                  <li className="px-3 py-2.5" key={id}>
            ...
            <Pager countLabel="3 of 50" next="#" prev="#" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            <Callout description="Default bordered box for advisory content." title="Neutral">
        ...
        <div>
          ...
          <ul className="pdpp-body space-y-2">
            <li>
              ...
              <a className="underline-offset-2 hover:underline" href="/sandbox/records">
...
function LongviewIdentityLockup({
  ...
  return (
    <div className="flex min-w-0 items-center gap-3">
      ...
      >
        <LongviewLogoMark className={markSizeClass} inverse={inverse} variant={variant} />
      </div>
...
function LongviewLogoMark({
  ...
  if (variant === "horizon_tile") {
    return (
      <svg aria-hidden="true" className={className} viewBox="0 0 128 80">
        <path
...
const LONGVIEW_VERDICT_TONES: Record<
                  ...
                  return (
                    ...
                    >
                      <div className="flex h-10 items-center justify-center">
                        <LongviewLogoMark className={markSizeClass} variant="aperture_span" />
                      </div>
            ...
            <div className="border-t pt-5" style={{ borderColor: "var(--border)" }}>
              ...
              <div className="flex flex-col">
                {LONGVIEW_LOGO_CANDIDATES.filter((candidate) => candidate.verdict !== "recommended").map(
                  (candidate) => (
                    <LongviewCandidatePreview candidate={candidate} key={candidate.id} />
                  )
                )}
              </div>
            </div>
            ...
            <div className="border-t pt-5" style={{ borderColor: "var(--border)" }}>
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <p className="text-xs leading-relaxed" key={rule} style={{ color: "var(--foreground)" }}>
                    {rule}
                  </p>
                ))}
              </div>
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-8">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <path d="M2 2l6 6M8 2l-6 6" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
                      </svg>
