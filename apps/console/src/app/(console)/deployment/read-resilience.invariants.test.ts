...
const USES_DETAIL_SKELETON_RE = /<DetailLoadingSkeleton\b/;
const DOES_NOT_USE_LIST_SKELETON_RE = /<ListLoadingSkeleton\b/;
const IMPORTS_LOADING_SKELETON_RE = /from\s+["']\.\.\/components\/route-loading\.tsx["']/;
const RECOVERING_TESTID_RE = /data-testid="deployment-read-recovering"/;
