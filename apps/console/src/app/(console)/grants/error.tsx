...
/**
 * Grants-segment error boundary (App Router convention) — SLVP bar: Stripe,
 ...
 *
 * `/grants` has no client-cached last-known-read marker, so this boundary
...
export default function GrantsError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
  ...
  return (
    <div data-testid="grants-read-recovering">
