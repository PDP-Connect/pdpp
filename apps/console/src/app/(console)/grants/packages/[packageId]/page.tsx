  ...
  return (
    <RecordroomShellWithPalette>
      <div className="pdpp-caption mb-2 text-muted-foreground">
        <Link className="underline-offset-2 hover:underline" href="/grants/packages">
          ← Grant packages
        </Link>
      </div>
      <PageHeader title="Grant package" />
            ...
            <>
              ...
              <dd className="break-all font-mono text-foreground">
                <Link
                  ...
                  href={`/grants/packages/${encodeURIComponent(pkg.parent_package_id)}`}
                >
                  {pkg.parent_package_id}
                </Link>
              </dd>
            ...
            {cumulative.packages.map((member) => (
              <li key={member.package_id}>
                <Link
                  ...
                  href={`/grants/packages/${encodeURIComponent(member.package_id)}`}
                >
