...
export function buildAddSourceDemoCatalog(): {
  ...
  return {
    catalog: [
      ...
      {
        // Illustrates the Development disclosure's real/unproven bucket: a
        // registered, implemented connector whose setup path resolves to a
        // real action, but no live run has proven it yet.
        acquisitionPaths: [],
        connectorKey: "podcast_history_demo",
        deploymentReadiness: { blockers: [], guidance: null, state: "ready" },
        displayName: "Podcast History Demo",
        disposition: "static_secret_connect",
        externalDocs: [],
        isKnownScaffold: false,
      ...
      {
        // Illustrates the Development disclosure's scaffold bucket: a
        // registered manifest whose collector is an unconditional SKIP_RESULT
        // placeholder. Never gets an add action, in the disclosure or anywhere else.
        acquisitionPaths: [],
        connectorKey: "receipts_scaffold_demo",
        deploymentReadiness: { blockers: [], guidance: null, state: "ready" },
        displayName: "Receipts Scaffold Demo",
        disposition: "browser_bound_runbook",
        externalDocs: [],
