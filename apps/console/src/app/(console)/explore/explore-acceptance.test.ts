...
const CANVAS_FILE = fileURLToPath(new URL("apps/console/src/app/(console)/explore/explore-canvas.tsx", REPO_ROOT));
...
const NAV_FILE = fileURLToPath(new URL("apps/console/src/app/(console)/explore/explore-navigation.ts", REPO_ROOT));
