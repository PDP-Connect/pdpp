...
export interface StreamSummary {
  count_state?: "known" | "known_zero" | "unobserved" | "stale" | "unknown";
  /**
   * Orthogonal declaration/count state pair (`reconcile-active-summary-evidence`
   * design.md "Explicit stream evidence"). `undefined` for a reference
...
export interface ConnectorOverview {
   ...
   * `undefined` for a caller predating this field, preserving the exact
   * prior always-authoritative rendering in `resolveRecordCountDisplay`.
   */
