...
test("hero is CALM with reassurance when all is well", () => {
  const clients: OwnerIssuedClient[] = [
    { client_id: "c1", client_name: "Claude Desktop", active_token_count: 1, created_at: NOW.toISOString(), last_used_at: null },
  ];
...
test("bearer section and hero count only active owner tokens", () => {
  const clients: OwnerIssuedClient[] = [
    { client_id: "inactive", client_name: "Old smoke client", active_token_count: 0, created_at: NOW.toISOString(), last_used_at: null },
    { client_id: "active", client_name: "Claude Desktop", active_token_count: 2, created_at: NOW.toISOString(), last_used_at: null },
  ];
...
test("bearer row carries the raw created_at for the shared IcTimestamp, not a prebaked date string", () => {
  const clients: OwnerIssuedClient[] = [
    { client_id: "c1", client_name: "Claude Desktop", active_token_count: 1, created_at: "2026-06-01T00:00:00Z", last_used_at: null },
  ];
  const data = buildStandingData(baseInputs({ bearerClients: clients }));
...
test('single-token bearer labels created_at "issued"; multi-token bearer degrades to "first issued"', () => {
  const single: OwnerIssuedClient[] = [
    { client_id: "one", client_name: "Solo", active_token_count: 1, created_at: NOW.toISOString(), last_used_at: null },
  ];
  const multi: OwnerIssuedClient[] = [
    { client_id: "many", client_name: "Legacy", active_token_count: 3, created_at: NOW.toISOString(), last_used_at: null },
  ];
...
test("buildStandingData wires bearers, relationships, lately, attention", () => {
  const clients: OwnerIssuedClient[] = [
    { client_id: "c1", client_name: "Claude Desktop", active_token_count: 2, created_at: "2026-06-01T00:00:00Z", last_used_at: null },
  ];
  const grant: GrantSummary = {
    object: "grant_summary",
    grant_id: "g1",
