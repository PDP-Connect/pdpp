...
// ── Generated hrefs are clean top-level owner routes ─────────────────────────

test("live command hrefs are clean top-level routes", () => {
...
test("the console default (no basePath) is the clean owner console root", () => {
