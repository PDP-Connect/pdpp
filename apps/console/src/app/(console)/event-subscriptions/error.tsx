...
/**
 * Event-subscriptions-segment error boundary (App Router convention) — SLVP
 ...
 *
 * `/event-subscriptions` has no client-cached last-known-read marker, so this
...
export default function EventSubscriptionsError({
  error,
  reset,
}: {
  ...
  return (
    <div data-testid="event-subscriptions-read-recovering">
