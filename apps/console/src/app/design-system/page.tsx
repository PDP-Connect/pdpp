 ...
 * /consent, /owner, /device), deliberately OUTSIDE the owner console
 * tree so it is not caught by the connector-redirect catch-all nor the
 * owner-session DAL gate. (A folder name without a leading underscore is required —
