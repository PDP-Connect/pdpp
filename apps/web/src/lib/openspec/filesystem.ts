...
let cachedGitMetadataManifest:
  | Promise<OpenSpecGitMetadataManifest | null>
  | null = null;
...
async function loadOpenSpecGitMetadataManifest(
  repoRoot: string,
): Promise<OpenSpecGitMetadataManifest | null> {
...
export async function listChangeDesignNoteFiles(
  repoRoot: string,
  changeName: string,
): Promise<string[]> {
