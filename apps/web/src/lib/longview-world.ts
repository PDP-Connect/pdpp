...
export const LONGVIEW_PAY_STATEMENT_GRANTED_FIELDS = [
  'employer',
  'pay_period',
  'gross_pay',
  'net_pay',
...
export const LONGVIEW_STREAM_DETAILS = {
  payStatements: 'Employer, pay period, gross pay, and net pay from each payroll cycle. No bank account details, home address, or tax ID fragments.',
  equityGrants: 'Grant type, quantity, vesting start, and vesting schedule. No brokerage account numbers or beneficiary details.',
  benefitsEnrollments: 'Plan name, coverage tier, and employer contribution. No dependent details, claims, or provider notes.',
} as const;
...
export const LONGVIEW_CONNECTOR_SPECIMEN: ConnectorCardProps = {
  ...
  profiles: [
    { id: 'career-move', label: 'Career move planning', streamCount: 3 },
  ],
};
