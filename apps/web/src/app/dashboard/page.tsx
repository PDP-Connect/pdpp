  ...
  return (
    <div className="pdpp-caption mb-8 flex flex-wrap items-center gap-3 rounded-md border border-destructive/30 border-l-4 border-l-destructive/60 bg-destructive/5 px-4 py-2.5">
      ...
      <div className="ml-auto flex flex-wrap items-center gap-3">
        <Link className="underline-offset-2 hover:underline" href="/dashboard/traces?status=failed">
          review traces →
        </Link>
        <Link className="underline-offset-2 hover:underline" href="/dashboard/runs?status=failed">
          review runs →
        </Link>
      </div>
    </div>
