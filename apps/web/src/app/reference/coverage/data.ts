...
export const coverageRows = [
  ...
  },
  {
    ...
    evidence: [
      ...
      webRoute("/dashboard/search", "apps/web/src/app/dashboard/search/page.tsx", "Live-instance search diagnostics"),
    ],
    notes: "Dashboard evidence is operator-facing live state, not protocol documentation.",
  },
  {
  ...
  },
  {
    ...
    evidence: [
      ...
      webRoute("/dashboard/traces", "apps/web/src/app/dashboard/traces/page.tsx", "Trace dashboard"),
    ],
  ...
  },
  {
    ...
    evidence: [
      ...
      webRoute("/dashboard/deployment", "apps/web/src/app/dashboard/deployment/page.tsx", "Deployment diagnostics"),
    ],
    notes: "Dashboard pages are live/operator surfaces and are intentionally outside public protocol docs.",
  },
  {
