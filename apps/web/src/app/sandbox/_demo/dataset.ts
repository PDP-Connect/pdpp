...
export const DEMO_CONNECTORS: readonly DemoConnectorDef[] = [
  {
    ...
    description: "Stand-in payroll connector for demo. No real Acme Corporation, employer, or paycheck data.",
    provenance: "native",
    schedule: "weekly",
  ...
  },
  {
    ...
    description: "Stand-in personal-health connector for demo. No real provider, patient, or visit data.",
