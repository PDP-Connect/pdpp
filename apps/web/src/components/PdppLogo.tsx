...
export function PdppLogo({
  ...
  return <Mark size={size} surface={surface} title={title} className={className} style={style} />;
}
...
function FaviconMark({ size, surface, title, className, style }: MarkProps) {
  ...
  return (
    <svg
      ...
      style={style}
    >
      <rect x="4" y="4" width="12" height="24" fill={warm} />
      <rect x="16" y="4" width="12" height="24" fill={cool} />
    </svg>
  );
}
