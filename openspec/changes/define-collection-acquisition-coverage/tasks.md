...
- [ ] 2.5 Add a generic coverage receipt after commit with accepted, duplicate, skipped, failed, time-range, and gap facts.
  - [x] 2.5a Validation receipt down-payment: the setup-status page renders the uploaded file, validation status, detected format, estimated point/segment counts, coverage window, and acquisition method. Full accepted/duplicate/skipped/failed committed counts remain deferred to acquisition-batch storage.
