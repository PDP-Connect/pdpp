...
- [x] 9.4 Full-suite acceptance: strict OpenSpec validation, reference-implementation/polyfill-connectors/console suites, all workspace typechecks, diff check, and touched-file lint delta. (Integrated 2026-07-21: reference and polyfill suites pass; console view-model and stream suites pass; the touched-file lint baseline and integrated diff both report 40 errors/48 warnings/8 infos, so the delta is non-positive.)
