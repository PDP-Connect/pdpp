...
- [x] 1.1 Pin and fingerprint the resolved workspace Biome/Ultracite versions,
      Node/pnpm versions, config hashes, and exact selected/excluded path sets.
- [x] 1.2 Add a machine-readable diagnostic receipt keyed by workspace, path, rule,
      category, message, and location, plus rule/severity totals and exception ledger.
- [x] 1.3 Adjudicate every active rule and exclusion as defect, style, mismatch, or
      domain exception; record owner, scope, invariant, and expiry for exceptions.
- [x] 1.4 Add selection mutation tests, including raw provider-capture exclusion,
...
- [x] 2.1 Make OpenAPI and site generated outputs generator-owned: run
