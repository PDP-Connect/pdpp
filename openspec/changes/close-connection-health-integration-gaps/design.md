...
| `fx-suite-v2-0711` | `3d7aff2ac` | **Keep** | Ratified test-only fix: two tests still referenced Amazon where the manifest/behavior contract had already moved the assertion to USAA; not a behavior change. |
