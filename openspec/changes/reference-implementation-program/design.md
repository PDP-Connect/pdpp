...
- the next control-plane hosting tranche is single-origin reference composition: keep the Next app and the AS/RS as internal processes, but present one browser-facing reference origin with shared owner session across `/owner/*` and `/dashboard/*`, proxied protocol/reference namespaces, and public metadata/verification URLs that point at the browser-facing origin rather than the internal `:7662/:7663` listen ports. This remains a reference-hosting choice, not a PDPP protocol requirement. See [`design-notes/single-origin-reference-composition-plan-2026-04-22.md`](design-notes/single-origin-reference-composition-plan-2026-04-22.md).
