...
- Add a small `ThemeProvider` + `ThemeToggle` client component pair under `apps/web/src/components/theme/` that exposes light / dark / system, persists explicit choices, and respects `prefers-reduced-motion`.
