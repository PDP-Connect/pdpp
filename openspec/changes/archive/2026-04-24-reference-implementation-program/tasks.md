...
- [x] Add a reference build/revision response header distinct from `PDPP-Version`
  - [x] Define the header name and semantics (`PDPP-Reference-Revision` or equivalent) as reference-implementation metadata, not protocol version negotiation
