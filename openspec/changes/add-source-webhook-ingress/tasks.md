...
- [ ] `openspec validate add-source-webhook-ingress --strict` passes
- [ ] `openspec validate --all --strict` passes with no regressions
- [ ] `node --test reference-implementation/test/ref-source-webhook-ingest-operation.test.js` passes
- [ ] `node --test reference-implementation/test/ref-source-webhook-route.test.js` passes
- [ ] `node --test reference-implementation/test/source-webhook-event-store.test.js` passes
- [ ] The spec delta accurately matches the implemented code (no invented requirements)
- [ ] No runtime code changes (spec-only tranche)
...
- [ ] Run `openspec validate add-source-webhook-ingress --strict`
- [ ] Run `openspec validate --all --strict`
- [ ] Owner review of spec delta against code
