...
- Render per-connection scope on the consent card (`apps/web/src/components/pdpp/consent-card.tsx`) and on the grant request flow, using `display_name` as the primary label.
