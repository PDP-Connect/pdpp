...
// only `lexical_retrieval` from the optional lexical-retrieval extension.
...
export const publicManifests = [
  ...
  },
  {
    ...
    surface: 'public',
    tags: ['metadata'],
    summary: 'Return RFC 9728 protected-resource metadata advertising the PDPP query base and owner-self-export capabilities.',
    responses: {
  ...
  },
  {
    ...
    responses: {
      ...
      400: { schema: ErrorObjectSchema, description: 'Invalid request' },
      403: { schema: ErrorObjectSchema, description: 'Request rejected because the resolved grant contract is invalid' },
    },
  },
  {
    id: 'approveConsent',
  ...
  },
  {
    ...
    surface: 'public',
    tags: ['records'],
    summary: 'List records in a stream under grant enforcement. Supports logical-cursor pagination, exact and declared range filters, and changes_since.',
    request: {
      headers: AuthHeaderSchema,
      params: StreamNamePathSchema,
  ...
  },
  {
    ...
    summary: 'Optional lexical retrieval extension: search records across authorized streams by text. See the lexical-retrieval capability spec.',
    request: {
      headers: AuthHeaderSchema,
    ...
    responses: {
      ...
      400: { schema: ErrorObjectSchema, description: 'Invalid request (e.g. unsupported v1 query parameter, missing q)' },
      401: { schema: ErrorObjectSchema, description: 'Missing or invalid access token' },
