...
export type NekoApplyViewport = (
  viewport: ViewportPayload,
  context?: NekoApplyViewportContext
) => Promise<void>;

export function createUnimplementedNekoApplyViewport(): NekoApplyViewport {
  return async (viewport) => {
    void viewport;
    throw new Error(
      "n.eko applyViewport is not implemented yet; wire aligned modeline snapping, Browser.setWindowBounds, and gutter-crop reporting here"
    );
  };
}
