import {
  parseRemoteSurfaceFormFieldRect,
  type RemoteSurfaceFormFieldRect,
...
export function parseCdpDetectedFormFields(value: unknown): readonly RemoteSurfaceFormFieldRect[] {
