...
export interface RemoteSurfaceViewer {
  ...
  dispatchPointer(payload: Extract<RemoteSurfaceInputPayload, { type: "pointer" }>): Promise<void>;
  dispatchKeyboard(payload: Extract<RemoteSurfaceInputPayload, { type: "keyboard" }>): Promise<void>;
  dispatchText(payload: Extract<RemoteSurfaceInputPayload, { type: "text" }>): Promise<void>;
