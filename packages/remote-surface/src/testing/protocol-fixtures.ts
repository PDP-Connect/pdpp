...
] as const satisfies readonly RemoteSurfaceEventPayload[];
...
] as const satisfies readonly RemoteSurfaceInputPayload[];
...
] as const satisfies readonly RemoteSurfaceViewportPayload[];
...
] as const satisfies readonly RemoteSurfaceClipboardPayload[];
...
] as const satisfies readonly RemoteSurfaceTargetDescriptor[];
