 ...
 */
export { BrowserSurfaceLeaseManager, projectBrowserSurfaceLease, } from "./surface-lease-manager.ts";
/**
 ...
 */
export type { AcquireBrowserSurfaceLeaseRequest, BrowserSurfaceLease, BrowserSurfaceLeaseConfig, BrowserSurfaceLeaseManagerOptions, BrowserSurfaceLeaseResult, BrowserSurfaceProjection, CleanupIdleBrowserSurfacesResult, CompleteBrowserSurfaceCapacityReclaimResult, ReconcileBrowserSurfaceLeasesAfterRestartRequest, ReconcileBrowserSurfaceLeasesAfterRestartResult, ReleaseBrowserSurfaceLeaseRequest, ReleaseBrowserSurfaceLeaseResult, RenewBrowserSurfaceLeaseRequest, RenewBrowserSurfaceLeaseResult, TerminalBrowserSurfaceLeaseResult, } from "./surface-lease-manager.ts";
