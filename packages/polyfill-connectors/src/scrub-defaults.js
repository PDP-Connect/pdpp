 ...
 *
 * Rules are {pattern: RegExp, replacement: string|fn, scope: 'all'|'html'|'json'}.
 * `scope: 'all'` applies to every captured file type.
 *
 * Connector-specific rules live in `connectors/<name>/scrub-rules.js`
...
export const defaultScrubRules = [
  ...
  // US phone numbers — permissive pattern covering (xxx) xxx-xxxx, xxx-xxx-xxxx,
  // +1 xxx xxx xxxx, etc.
  {
