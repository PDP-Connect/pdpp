...
export const tweetsFixture: TweetFixture[] = [
  {
    tweet: {
      id_str: "1001",
      id: "1001",
      ...
      retweet_count: "7",
      lang: "en",
      entities: { media: [{ id: "m1" }], urls: [{ url: "https://t.co/abc" }, { url: "https://t.co/def" }] },
    },
  },
  {
    tweet: {
  ...
  },
  {
    tweet: {
      ...
      lang: "fr",
      entities: { media: [], urls: [{ url: "https://t.co/xyz", expanded_url: "https://example.com/a?b=c&d=e" }] },
    },
  },
  { tweet: { id_str: "1004", full_text: "No created_at — should be skipped by the record builder" } },
];

export function renderTweetsFixture(): string {
  return `window.YTD.tweets.part0 = ${JSON.stringify(tweetsFixture, null, 2)};\n`;
}
