...
Inputs: 67 claims · 33 cost entries · 55 packets · input digest `0cb8a3bd` (identical ledgers compile to identical bytes).
...
- ⚠ doctrine-named target 'storage-backend-contract-unification' has ZERO realized spend for 3 consecutive batches (batch-ce5b07e8, batch-c73d3660, batch-0c1ede83)
- ⚠ doctrine-named target 'auth-substrate-policy-split' has ZERO realized spend for 3 consecutive batches (batch-ce5b07e8, batch-c73d3660, batch-0c1ede83)
- ⚠ doctrine-named target 'auth-mutation-killing-tests' has ZERO realized spend for 3 consecutive batches (batch-ce5b07e8, batch-c73d3660, batch-0c1ede83)
- ⚠ class 'B' allocation outside the doctrine band 40-50% for 3 consecutive batches (realized: 0%, 0%, 0%)
- ⚠ class 'A2' allocation outside the doctrine band 30-40% for 3 consecutive batches (realized: 94%, 64%, 73%)
- ⚠ class 'T1' allocation outside the doctrine band 10-15% for 3 consecutive batches (realized: 6%, 17%, 21%)
...
- 1× touchset-violation (revision cycle): reference-implementation/probe-driver.mjs, reference-implementation/probe-stdin.mjs; ALL changes reverted
...
- total: $67.60 across 33 job(s) (32 with cost data) · 14835.6s wall
- per landed packet: $6.76 (10 landed)
- tokens: 855686 in / 482254 out (providers that reported them)
- revisions: 14 across 33 job(s) (0.42/job)
- judge results: (none) 13 · PASS 10 · REVISE 8 · REJECT 2
...
- budget composition (computed): predicted — A2 $5.86 (49%) · B $0.00 (0%) · other $3.12 (26%) · T0 $0.35 (3%) · T1 $2.68 (22%) | realized — A2 $35.68 (53%) · other $13.64 (20%) · T0 $4.16 (6%) · T1 $14.12 (21%)
...
- A2: predicted 4 item(s), est $11.72 → realized: landed 1, pending 4, skipped 1 · spent $35.68 · 3 item(s) not packet-linked
- B: predicted 5 item(s), est $0.54 (4 without $) → realized: pending 1 · 4 item(s) not packet-linked
- evidence-generation: predicted 7 item(s), est $4.80 → realized: landed 4, pending 2 · spent $10.45 · 3 item(s) not packet-linked
...
- verified_fact: 15
- judged_design_claim: 18
- behavior_preserved: 9
- uncertainty: 1
- remaining_work: 24
