...
export const DEFAULT_LOCAL_DCR_INITIAL_ACCESS_TOKEN =
  'pdpp-reference-local-initial-access-token';

export const DEFAULT_PRE_REGISTERED_PUBLIC_CLIENTS = Object.freeze([
  ...
  { client_id: 'pdpp-web-dashboard', metadata: { client_name: 'PDPP Reference Dashboard', token_endpoint_auth_method: 'none' } },
  { client_id: 'pdpp-polyfill-owner-bootstrap', metadata: { client_name: 'PDPP Polyfill Owner Bootstrap', token_endpoint_auth_method: 'none' } },
]);
