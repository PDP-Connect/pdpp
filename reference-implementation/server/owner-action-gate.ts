...
function actionSatisfactionKind(action: RequiredAction): string | null {
...
function actionSurfaceKind(action: RequiredAction): string {
...
function isAutomationBlockingOwnerAction(action: RequiredAction): boolean {
...
export function unresolvedOwnerActionEvidenceFromSummary(
  summary: Summary,
  routeId: string | null = null
): UnresolvedOwnerActionEvidence | null {
