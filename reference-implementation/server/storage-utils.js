 ...
 * @param {string|{connector_id?: string, connectorId?: string}|null|undefined} storageTarget
 * @returns {string|null}
 */
export function resolveStorageConnectorId(storageTarget) {
 ...
 * @param {{connector_instance_id?: string, connectorInstanceId?: string}|null|undefined} storageTarget
 * @param {string} connectorId
 * @returns {string}
 */
export function resolveStorageConnectorInstanceId(storageTarget, connectorId) {
  if (storageTarget && typeof storageTarget === 'object') {
 ...
 * @returns {number}
 */
export function getChangeHistoryLimit() {
