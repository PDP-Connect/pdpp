...
export interface ReferenceQueryRegistry extends Readonly<Record<string, RegisteredQuery>> {
  ...
  readonly blobsGetRowByRange: ReadOneQuery;
  ...
  readonly connectorInstancesListByIds: ReadManyQuery;
  ...
  readonly deviceExportersInsertProcessingBatch: MutationQuery;
  ...
  readonly recordsDeleteAdvanceRecordResetGeneration: MutationQuery;
...
export function loadReferenceQueries(queryDir = QUERIES_DIR): ReferenceQueryRegistry {
  ...
  for (const requiredKey of [
    ...
    "recordsIngestListVersionCountersByInstance",
    ...
    "recordsIngestRepairCurrentDerivedFacts",
    // Records — point reads.
    ...
    "recordsDeleteProbeVersionCounterRow",
    "recordsDeleteProbeLiveCanonicalRecord",
    "recordsDeleteAdvanceRecordResetGeneration",
    "recordsDeleteGetRecordResetGeneration",
