...
function assertManagedNekoSettleEndpoint(descriptor) {
  if (!descriptor.surface_id || !descriptor.window_settle_endpoint) return;
  ...
  let candidate;
  try {
    candidate = new URL(descriptor.window_settle_endpoint);
  } catch {
    throw new RunTargetError(
