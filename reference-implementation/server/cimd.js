...
/**
 * Classify a dotted IPv4 address for SSRF safety.
 * Returns null when value is not dotted IPv4; otherwise returns whether it is forbidden.
 */
function classifyIpv4Address(value) {
...
export function isForbiddenIp(ip) {
  ...
  // IPv4 checks
  const ipv4Classification = classifyIpv4Address(normalized);
  if (ipv4Classification !== null) return ipv4Classification;
