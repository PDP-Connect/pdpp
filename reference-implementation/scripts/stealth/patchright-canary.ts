...
//   node scripts/stealth/patchright-canary.ts
//
...
// The `addInitScript`/`page.evaluate` callbacks below run in the browser.
// The DOM lib is intentionally not loaded into this script's TS program, so
// declare the browser globals they use as ambient `any` for this file only.
// biome-ignore lint/suspicious/noExplicitAny: browser globals, no DOM lib
