...
import { bucketStartForGranularity, resolveAggregateTimeZone } from "../server/record-aggregation.ts";
...
test("bucketStartForGranularity: null / unparseable value routes to the null bucket", () => {
  ...
  assert.equal(bucketStartForGranularity(1_735_776_000_000, "day", "UTC"), null);
});
