  ...
  assert.deepEqual(records, [
    {
      ...
      scope_size: 41,
      skipped: 0,
      terminal_fold_events_read: 0,
      terminal_fold_minimum_checkpoint_after: null,
      terminal_fold_minimum_checkpoint_before: null,
      terminal_fold_participants: 0,
      terminal_fold_zero_progress: false,
