...
import type { RefConnectorDetailEnvelope } from "../operations/ref-connectors-detail/index.ts";
import {
  executeRefConnectorDetail,
  RefConnectorDetailNotFoundError,
} from "../operations/ref-connectors-detail/index.ts";

function makeDetailWithoutObject(connectorId: string): Omit<RefConnectorDetailEnvelope, "object"> {
  return {
    ...
    streams: [],
    total_records: 0,
    total_records_state: "known_zero",
  };
}
