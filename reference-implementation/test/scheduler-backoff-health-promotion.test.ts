...
import { type ComputeBackoffOptions, computeNextRunWithBackoff } from "../runtime/scheduler-backoff.ts";
...
function streak(n: number): RunRecord[] {
  return Array.from({ length: n }, () => ({
    ...
    runId: null,
    source: { id: "c", kind: "connector" as const },
    startedAt: T,
...
function decide(n: number, options: ComputeBackoffOptions = {}) {
