...
import { isLocalOrPrivateRequestOrigin, type ResolvePublicUrlRequest } from "../server/metadata.ts";

function reqWithHost(host: string): ResolvePublicUrlRequest {
  return {
    get(name: string) {
...
function classify(host: string): boolean {
