...
import {
  ...
  type ConnectionRunEvidence,
  computeConnectionHealth,
} from "../runtime/connection-health.ts";

const NOW = "2026-05-19T12:00:00.000Z";

const MANUAL_REFRESH: ConnectionRefreshEvidence = Object.freeze({
  backgroundSafe: false,
  recommendedMode: "manual",
});

const ASSISTED_REFRESH: ConnectionRefreshEvidence = Object.freeze({
  backgroundSafe: true,
  interactionPosture: "otp_likely",
  recommendedMode: "automatic",
});

const AUTOMATIC_REFRESH: ConnectionRefreshEvidence = Object.freeze({
  backgroundSafe: true,
...
function findCondition(snapshot: ConnectionHealthSnapshot, type: ConnectionHealthCondition["type"]) {
