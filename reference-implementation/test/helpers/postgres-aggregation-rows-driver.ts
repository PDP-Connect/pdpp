...
import { CONFORMANCE_CONNECTOR_ID, CONFORMANCE_MANIFEST } from "./aggregation-rows-conformance.ts";
 ...
 */
export function createPostgresAggregationRowsDriver({ connectionString }: { connectionString: string | undefined }) {
  if (!connectionString) {
